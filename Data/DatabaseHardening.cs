...
public static class DatabaseHardening
{
    public static async Task ApplyAsync(AppDbContext db)
    {
        await db.Database.ExecuteSqlRawAsync("""
            ...
            CREATE OR REPLACE FUNCTION set_review_seller_reply(
                p_review_id UUID,
            ...
            BEGIN
                ...
                JOIN shops shop ON shop.id = product.shop_id
            ...
            REVOKE ALL ON FUNCTION refresh_product_review_stats(UUID) FROM PUBLIC;
            REVOKE ALL ON FUNCTION set_review_seller_reply(UUID, UUID, TEXT) FROM PUBLIC;
            GRANT EXECUTE ON FUNCTION refresh_product_review_stats(UUID) TO craftora_app;
            GRANT EXECUTE ON FUNCTION set_review_seller_reply(UUID, UUID, TEXT) TO craftora_app;
