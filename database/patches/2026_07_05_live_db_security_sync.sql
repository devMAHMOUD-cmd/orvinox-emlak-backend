-- ============================================================================
-- Craftora live DB security sync patch
-- Date: 2026-07-05
-- Purpose: Synchronize startup hardening SQL with the verified live database
--          dump used as source of truth.
-- Source: pg_dump schema captured on 2026-07-05 and mirrored in
--         Data/DatabaseHardening.cs.
-- ============================================================================
